...
| File | Description |
|------|-------------|
| [ Messy Dataset](employee_data_messy.xlsx) | Raw dataset with all original data quality issues (1,256 rows) |
| [ Cleaned Dataset](employee_data_clean.xlsx) | Final cleaned and analysis-ready dataset (~1,192 rows) |
